...
ALLOWED_HOSTS = [
    'edulearn-6xzb.onrender.com',
    'web-o2q2lzb95asz.up-de-fra1-k8s-1.apps.run-on-seenode.com',
]
...
FRONTEND_URL = config('FRONTEND_URL', default='https://edulearn-6xzb.onrender.com')
PAYPAL_TEST = True
